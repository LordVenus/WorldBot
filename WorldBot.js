...
'deu-lhe um biscoito que ele encontrou no chão. Que absurdo! Não aceite.',
'deu-lhe um biscoito de açúcar.',
'deu-lhe um biscoito de chocolate com... Espere! Isso são passas. Bler',
'deu-lhe um biscoito enooorme! Que delícia.',
'deu-lhe um biscoito premiado. O que você vai fazer com o prêmio?"',
'deu-lhe um biscoito da sorte. Nele está escrito: "Use camisinha!"',
'deu-lhe um biscoito da sorte. Nele está escrito: "Me chama que eu vou!"',
'deu-lhe um biscoito da sorte. Nele está escrito: "Cuidado com as más línguas."',
'deu-lhe um biscoito da sorte. Nele está escrito: "Pisa no recalque!"',
'deu-lhe um biscoito da sorte. Nele está escrito: "Amigo de verdade é aquele que lhe ajuda a fazer a chuca."',
'deu-lhe um biscoito da sorte. Nele está escrito: "Estou interessado em você."',
'deu-lhe um biscoito da sorte. Nele está escrito: "Toque uma música para mim?"',
'deu-lhe um biscoito da sorte. Nele está escrito: "Me toco pensando em você',
'deu-lhe um biscoito de ouro. Você não pode comer, pois é de ouro.',
'deu-lhe um biscoito da sorte. Nele está escrito: :trollface:',
'deu-lhe um biscoito arco-íris. Tão gay quanto vocês!',
'deu-lhe um biscoito negro. Chuta que é macumba!',
'deu-lhe um biscoito. Reparta com os amigos.'
],
getCookie: function () {
